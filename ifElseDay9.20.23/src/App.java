...
System.out.println();
    ...
    public static String codeMaker(String input){
        ...
        input=input.substring(0,input.l)
        String newString = input.substring(1,3)+temp2+input.substring(3,4)+temp+input.substring(4,5)+"a"+input.substring(5,input.length())+"y";
